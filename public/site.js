(() => {
	...
	form.addEventListener("submit", async (event) => {
		...
		try {
			...
			if (error) {
				const phone = document.querySelector(".call-fab span");
				error.textContent = location.protocol === "file:"
					? `Le formulaire a besoin du site en ligne. Appelle${phone ? " au " + phone.textContent.trim() : "-nous"}.`
					: errorValue.message || "Envoi impossible.";
				error.hidden = false;
			}
